...
Country.create(
  [
    ...
    { :code => "au", :name => "Australia", :full_name => "Commonwealth of Australia", :language => 'en'},
    { :code => "at", :name => "Austria", :full_name => "Republic of Austria"},
    { :code => "az", :name => "Azerbaijan", :full_name => "Republic of Azerbaijan"},
    { :code => "bs", :name => "Bahamas", :full_name => "Commonwealth of The Bahamas", :language => 'en'},
    { :code => "bh", :name => "Bahrain", :full_name => "Kingdom of Bahrain"},
    { :code => "bd", :name => "Bangladesh", :full_name => "People's Republic of Bangladesh", :language => 'en'},
    ...
    { :code => "bw", :name => "Botswana", :full_name => "Republic of Botswana", :language => 'en'},
    ...
    { :code => "kh", :name => "Cambodia", :full_name => "Kingdom of Cambodia", :language => 'en fr'},
    { :code => "cm", :name => "Cameroon", :full_name => "Republic of Cameroon"},
    { :code => "ca", :name => "Canada", :language => 'en fr'},
    ...
    { :code => "cn", :name => 'China', :full_name => "People's Republic of China", :language => 'zh'},
    ...
    { :code => "dm", :name => "Dominica", :full_name => "Commonwealth of Dominica", :language => 'en'},
    ...
    { :code => "er", :name => "Eritrea", :full_name => "State of Eritrea", :language => 'en ar'},
    ...
    { :code => "fj", :name => "Fiji", :full_name => "Republic of Fiji", :language => 'en'},
    ...
    { :code => "gm", :name => "The Gambia", :full_name => "Republic of The Gambia", :language => 'en'},
    { :code => "ge", :name => "Georgia"},
    { :code => "de", :name => "Germany", :full_name => "Federal Republic of Germany"},
    { :code => "gh", :name => "Ghana", :full_name => "Republic of Ghana", :language => 'en'},
    ...
    { :code => "gy", :name => "Guyana", :full_name => "Co-operative Republic of Guyana", :language => 'en'},
    { :code => "ht", :name => "Haiti", :full_name => "Republic of Haiti"},
    { :code => "hn", :name => "Honduras", :full_name => "Republic of Honduras"},
    { :code => "hk", :name => "Hong Kong", :full_name => "Hong Kong Special Administrative Region of the People's Republic of China", :language => 'zh'},
    { :code => "hu", :name => "Hungary"},
    { :code => "is", :name => "Iceland", :full_name => "Republic of Iceland"},
    { :code => "in", :name => "India", :full_name => "Republic of India", :language => 'en'},
    ...
    { :code => "ke", :name => "Kenya", :full_name => "Republic of Kenya", :language => 'en'},
    { :code => "ki", :name => "Kiribati", :full_name => "Republic of Kiribati", :language => 'en'},
    ...
    { :code => "ls", :name => "Lesotho", :full_name => "Kingdom of Lesotho", :language => 'en'},
    { :code => "lr", :name => "Liberia", :full_name => "Republic of Liberia", :language => 'en'},
    { :code => "ly", :name => "Libya"},
    ...
    { :code => "mo", :name => "Macau", :full_name => "Macao Special Administrative Region of the People's Republic of China", :language => 'zh'},
    { :code => "mk", :name => "Macedonia", :full_name => "Republic of Macedonia"},
    { :code => "mg", :name => "Madagascar", :full_name => "Republic of Madagascar"},
    { :code => "mw", :name => "Malawi", :full_name => "Republic of Malawi", :language => 'en'},
    ...
    { :code => "mt", :name => "Malta", :full_name => "Republic of Malta", :language => 'en'},
    { :code => "mh", :name => "Marshall Islands", :full_name => "Republic of the Marshall Islands", :language => 'en'},
    { :code => "mr", :name => "Mauritania", :full_name => "Islamic Republic of Mauritania"},
    { :code => "mu", :name => "Mauritius", :full_name => "Republic of Mauritius", :language => 'en fr'},
    { :code => "mx", :name => "Mexico", :full_name => "United Mexican States"},
    { :code => "fm", :name => "Federated States of Micronesia", :language => 'en'},
    ...
    { :code => "na", :name => "Namibia", :full_name => "Republic of Namibia", :language => 'en'},
    { :code => "nr", :name => "Nauru", :full_name => "Republic of Nauru", :language => 'en'},
    ...
    { :code => "ng", :name => "Nigeria", :full_name => "Federal Republic of Nigeria", :language => 'en'},
    ...
    { :code => "pk", :name => "Pakistan", :full_name => "Islamic Republic of Pakistan", :language => 'en'},
    { :code => "pw", :name => "Palau", :full_name => "Republic of Palau", :language => 'en'},
    { :code => "pa", :name => "Panama", :full_name => "Republic of Panama"},
    { :code => "pg", :name => "Papua New Guinea", :full_name => "Independent State of Papua New Guinea", :language => 'en'},
    { :code => "py", :name => "Paraguay", :full_name => "Republic of Paraguay"},
    { :code => "pe", :name => "Peru", :full_name => "Republic of Peru"},
    { :code => "ph", :name => "Philippines", :full_name => "Republic of the Philippines", :language => 'en'},
    ...
    { :code => "rw", :name => "Rwanda", :full_name => "Republic of Rwanda", :language => 'en'},
    { :code => "kn", :name => "Saint Kitts and Nevis", :full_name => "Federation of Saint Christopher and Nevis", :language => 'en'},
    { :code => "lc", :name => "Saint Lucia"},
    { :code => "vc", :name => "Saint Vincent and the Grenadines", :language => 'en'},
    { :code => "ws", :name => "Samoa", :full_name => "Independent State of Samoa", :language => 'en'},
    ...
    { :code => "sc", :name => "Seychelles", :full_name => "Republic of Seychelles", :language => 'en fr'},
    { :code => "sl", :name => "Sierra Leone", :full_name => "Republic of Sierra Leone", :language => 'en'},
    { :code => "sg", :name => "Singapore", :full_name => "Republic of Singapore", :language => 'zh en'},
    ...
    { :code => "so1", :name => "Somaliland", :full_name => "Republic of Somaliland", :alias => 'DISPUTED', :language => 'en ar'},
    { :code => "za", :name => "South Africa", :full_name => "Republic of South Africa", :language => 'en'},
    { :code => "ss", :name => "South Sudan", :full_name => "Republic of South Sudan", :language => 'en'},
    { :code => "es", :name => "Spain", :full_name => "Kingdom of Spain"},
    { :code => "lk", :name => "Sri Lanka", :full_name => "Democratic Socialist Republic of Sri Lanka", :language => 'en'},
    { :code => "sd", :name => "Sudan", :full_name => "Republic of the Sudan", :language => 'en ar'},
    { :code => "sr", :name => "Suriname", :full_name => "Republic of Suriname"},
    { :code => "sz", :name => "Swaziland", :full_name => "Kingdom of Swaziland", :language => 'en'},
    ...
    { :code => "tz", :name => "Tanzania", :full_name => "United Republic of Tanzania", :language => 'en'},
    { :code => "th", :name => "Thailand", :full_name => "Kingdom of Thailand"},
    { :code => "tg", :name => "Togo", :full_name => "Togolese Republic"},
    { :code => "to", :name => "Tonga", :full_name => "Kingdom of Tonga", :language => 'en'},
    { :code => "tt", :name => "Trinidad and Tobago", :full_name => "Republic of Trinidad and Tobago", :language => 'en'},
    ...
    { :code => "ug", :name => "Uganda", :full_name => "Republic of Uganda", :language => 'en'},
    { :code => "ua", :name => "Ukraine"},
    { :code => "ae", :name => "United Arab Emirates"},
    { :code => "gb", :name => 'United Kingdom', :full_name => 'United Kingdom of Great Britain and Northern Ireland', :language => 'en'},
    { :code => "us", :name => 'United States', :full_name => 'United States of America', :language => 'en'},
    { :code => "uy", :name => "Uruguay", :full_name => "Oriental Republic of Uruguay"},
    { :code => "uz", :name => "Uzbekistan", :full_name => "Republic of Uzbekistan"},
    { :code => "vu", :name => "Vanuatu", :full_name => "Republic of Vanuatu", :language => 'en fr'},
    ...
    { :code => "zm", :name => "Zambia", :full_name => "Republic of Zambia", :language => 'en'},
    { :code => "zw", :name => "Zimbabwe", :full_name => "Republic of Zimbabwe", :language => 'en'}
  ]
)