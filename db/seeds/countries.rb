Country.create(
  [
    ...
    { :code => "ba", :name => "Bosnia and Herzegovina", :full_name => "Bosnia and Herzegovina"},
    ...
    { :code => "cd", :name => "Congo, Democratic Republic of the", :full_name => "Congo, Democratic Republic of the", :alias => "Congo-Kinshasa"},
    { :code => "cg", :name => "Congo, Republic of the", :full_name => "Congo, Republic of the"},
    ...
    { :code => "kp", :name => 'Korea, North', :full_name => "Democratic People's Republic of Korea"},
    { :code => "kr", :name => "Korea, South", :full_name => "Republic of Korea"},
    ...
    { :code => "nc", :name => "Northern Cyprus", :full_name => "Turkish Republic of Northern Cyprus"},
    ...
    { :code => "pt", :name => "Puerto Rico", :full_name => "Commonwealth of Puerto Rico"},
