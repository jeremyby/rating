...
CREATE TABLE "polls" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "slug" varchar(255), "question" varchar(255) NOT NULL, "ballots_count" integer, "yes" varchar(255) DEFAULT 'Yes' NOT NULL, "no" varchar(255) DEFAULT 'No' NOT NULL, "yes_positive" boolean DEFAULT 't' NOT NULL, "user_id" integer NOT NULL, "country_code" varchar(255) NOT NULL, "category" integer DEFAULT 4 NOT NULL, "coverage" integer DEFAULT 0 NOT NULL, "weight" integer DEFAULT -1 NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL, "featured" boolean DEFAULT 'f', "positive_ballots_count" integer, "negative_ballots_count" integer);
...
CREATE TABLE "ballots" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "poll_id" integer NOT NULL, "user_id" integer NOT NULL, "country_code" varchar(255) NOT NULL, "vote" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE INDEX "index_ballots_on_poll_id" ON "ballots" ("poll_id");
CREATE INDEX "index_ballots_on_user_id" ON "ballots" ("user_id");
